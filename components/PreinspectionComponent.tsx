...
//       setItem1(item1 || []);
//       setItem2(item2 || []);
//       setMasterId(item1[0]?.masterId || 0);
//       setTimeout(() => {
//         setLoading(false);
//       }, 1600);
//     }
...
//   let tBoxes = item1.length;
//   let tBoxesOutline = item1.filter((item) => item.toOutline).length;
//   let tBoxesStatusProcessed = item1.filter((item) => item.statusId === 1)
//     .length;
//     let tBoxesStatusOutline = item1.filter((item) => item.statusId === 2)
//     .length;
//     let tBoxesMissing = item1.filter((item) => item.statusId === 0).length;
//     let tHousesToOutline = item2.filter((item) => item.toOutline).length;
//   let tHousesInOutline = item2.filter((item) => item.statusId === 2).length;
...
//             <IconMaterialCE name="lightbulb-on" color={"#FFFF"} size={40} />
